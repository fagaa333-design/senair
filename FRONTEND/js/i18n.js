...
(function () {
  ...
  const PHRASE_PAIRS = [
    ...
    ["Caribe & Sierra", "Caribbean & Mountains"],
    ["Reservar vuelo", "Book flight"],
    ["Historias, sabores y paisajes nacionales e internacionales esperando por ti.", "National and international stories, flavors and landscapes waiting for you."],
    ["Nacional · Caribe", "National · Caribbean"],
    ["Internacional · Europa", "International · Europe"],
    ["Nacional · Montaña", "National · Mountain"],
    ["Internacional · EE. UU.", "International · USA"],
    ["Nacional · Caribe & Sierra", "National · Caribbean & Mountains"],
    ["Arte, grandes plazas, gastronomía y noches llenas de vida.", "Art, grand squares, gastronomy and lively nights."],
    ["Playas icónicas, arte vibrante y una energía costera única.", "Iconic beaches, vibrant art and unique coastal energy."],
    ["La ciudad de la luz, arquitectura legendaria y romanticismo.", "The city of light, legendary architecture and romance."],
    ["Historia colonial, playas y calles llenas de magia y color.", "Colonial history, beaches and streets full of magic and color."],
    ["Naturaleza, innovación y la ciudad de la eterna primavera.", "Nature, innovation and the city of eternal spring."],
    ["Playas doradas, bahías cristalinas y la Sierra Nevada.", "Golden beaches, crystal bays and the Sierra Nevada."],
    ["Cultura, museos, gastronomía y el pulso vibrante de la capital.", "Culture, museums, cuisine and the vibrant pulse of the capital."],
    ["La capital de la salsa, calidez de su gente y brisa inolvidable.", "The salsa capital, warmth of its people and unforgettable breeze."],
    ["Descubrir todos los destinos", "Discover all destinations"],
